...
:Category: Blog
:Tags: pelican, publishing, rst
:Slug: my-first-post
:Author: Test User
:Summary: Short summary for my first post, demonstrating various reStructuredText features.
...
You can also include links, for example, to the `Pelican documentation <https://getpelican.com/>`_.
